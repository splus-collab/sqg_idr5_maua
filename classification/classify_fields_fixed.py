...
import glob
import os
from paths import save_path, correction_path, wise_path
import logging
import pandas as pd
...
logging.basicConfig(filename=os.path.join(save_path,"classification.log"),format='%(asctime)s: %(levelname)s: %(message)s',  filemode='w', level=logging.DEBUG)
